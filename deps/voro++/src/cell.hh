...
class voronoicell_base {
	public:
		...
		void draw_povs(double x,double y,double z,FILE *fp=stdout);
		...
		void normals_with_edges(std::vector<double> &v, std::vector<double> &w);
	...
	private:
		...
		inline void normals_with_edges_search(std::vector<double> &v,std::vector<double> &w,int i,int j,int k);
